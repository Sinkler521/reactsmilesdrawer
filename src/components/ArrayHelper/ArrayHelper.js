 ...
 */
export const ArrayHelper = class {
    /**
     ...
     * @param {*} arr[].id If the array contains an object with the property 'id', the properties value is printed. Else, the array elements value is printed.
     ...
     * @param {Array} arrA An array.
     * @param {Array} arrB An array.
     * @returns {Array} The intersecting values.
     */
