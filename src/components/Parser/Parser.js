...
export const Parser = () => {
    ...
    /*
     * Skeleton generated by PEG.js 0.10.0 and reworked as React component
     *
     * http://pegjs.org/
     */
  
    const peg$subclass = (child, parent) => {
      const ctor = function () {
    ...
    const peg$SyntaxError = (message, expected, found, location) => {
    ...
    peg$SyntaxError.buildMessage = function (expected, found) {
        ...
        const describeExpectation = (expectation) => {
    ...
    const peg$parse = (input, options) => {
        options = options !== void 0 ? options : {};
    
        // KEEP THIS WHEN REGENERATING THE PARSER !!
        let nOpenParentheses = input.split('(').length - 1;
        let nCloseParentheses = input.split(')').length - 1;
